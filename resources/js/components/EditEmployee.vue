...
<script>
    ...
    export default {
        ...
        created() {
            axios.get('/employee/'+this.employeeid).then(res => {
                this.salary = res.data.employee.current_salary;
                this.image = res.data.employee.image;
                this.jobTitle = res.data.employee.job_title;
        ...
        methods: {
            ...
            createEmployee(){
                ...
                console.log(dataObj)
                axios.post('/update-employee/'+this.employeeid, dataObj).then(res => {
